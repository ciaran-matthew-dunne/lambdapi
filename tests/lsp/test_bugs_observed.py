"""Tests for two bugs observed in live editor usage:

1. cross-file go-to-def landing on line 0 instead of the actual
   declaration line
2. go-to-def on the module name in `require open Foo.Bar` returning
   null
"""
