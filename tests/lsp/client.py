...
class LSPServer:
    ...
    def __init__(self, lib_root, map_dirs=None, standard_lsp=True,
        ...
        self._pending = {}
        # Start at 0, like Zed: id 0 is a valid JSON-RPC request id and
        # servers must reply to it (regression: an `id <> 0` sentinel
        # in the server left Zed's initialize unanswered).
        self._next_id = 0
